...
export const commands = {
	...
	writeFile: (path: string, content: string) => typedError<null, CmdError>(__TAURI_INVOKE("write_file", { path, content })),
	saveFile: (path: string, content: string) => typedError<null, CmdError>(__TAURI_INVOKE("save_file", { path, content })),
